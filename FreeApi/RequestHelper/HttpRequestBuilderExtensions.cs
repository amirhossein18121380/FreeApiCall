...
namespace FreeApi.RequestHelper;
...
public static class HttpRequestBuilderExtensions
{
    ...
    {
        return builder.WithJsonContent<T>(content, XHttpClientOptions.DefaultJsonSerializerOptions);
    }
    ...
    {
        return builder.WithXmlContent(obj, XXmlSerializer.DefaultSettings.Encoding, XXmlSerializer.DefaultContentType);
    }
    ...
    {
        return builder.WithXmlContent(obj, encoding, XXmlSerializer.DefaultContentType);
    }
    ...
    {
        return builder.WithXmlContent(obj, XXmlSerializer.DefaultSettings.Encoding, contentType);
    }
    ...
    {
        var settings = XXmlSerializer.DefaultSettings;
        settings.Encoding = encoding;

        var xml = XXmlSerializer.Serialize(obj, settings);
    ...
    {
        return builder.WithXmlContent(xml, XXmlSerializer.DefaultSettings.Encoding, XXmlSerializer.DefaultContentType);
    }
    ...
    {
        return builder.WithXmlContent(xml, encoding, XXmlSerializer.DefaultContentType);
    }
    ...
    {
        return builder.WithXmlContent(xml, XXmlSerializer.DefaultSettings.Encoding, contentType);
    }
