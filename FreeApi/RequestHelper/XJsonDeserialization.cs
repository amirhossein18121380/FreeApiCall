...
/// </summary>
public static class XJsonDeserialization
{
    ...
    {
        return value.DeserializeJson<T>(XHttpClientOptions.DefaultJsonSerializerOptions);
    }
    ...
    public static async Task<T?> DeserializeJsonAsync<T>(this Task<string> stringTask)
    {
        return await stringTask
            .DeserializeJsonAsync<T>(XHttpClientOptions.DefaultJsonSerializerOptions)
    ...
    public static async Task<T?> DeserializeJsonAsync<T>(this Task<HttpResponseMessage> responseMessageTask, Func<HttpResponseMessage, Exception, Task<T>> defaultAction)
    {
        return await responseMessageTask
            .DeserializeJsonAsync<T>(defaultAction, XHttpClientOptions.DefaultJsonSerializerOptions, CancellationToken.None)
            .ConfigureAwait(false);
    }
    ...
    {
        return await responseMessageTask
            .DeserializeJsonAsync<T>(defaultAction, XHttpClientOptions.DefaultJsonSerializerOptions, token)
            .ConfigureAwait(false);
    }
    ...
    {
        return await responseMessageTask
            .DeserializeJsonAsync<T>(XHttpClientOptions.DefaultJsonSerializerOptions, CancellationToken.None)
            .ConfigureAwait(false);
    }
    ...
    {
        return await responseMessageTask
            .DeserializeJsonAsync<T>(XHttpClientOptions.DefaultJsonSerializerOptions, token)
            .ConfigureAwait(false);
    }
